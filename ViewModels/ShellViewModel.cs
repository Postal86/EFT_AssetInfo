...
namespace ETFHelper_WPF.ViewModels
{
    public class ShellViewModel : Screen
    {
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            var informations = _settingsService.WindowInformations;
        ...
        private void _flyoutService_ShowFlyoutRequested(object sender, FlyoutRequest e)
        {
            ...
            FlyoutPosition = (Position)e.Position;
        ...
        {
            _settingsService.WindowInformations.Copy(this);
        ...
        {
            await _dialogService.ShowProgressAsync("მიდის აფდეითი", "ETFHelper დარესტარტდება...", UpdateApplication());
        }
        ...
        private async Task<string> GetCurrencyValue(Currencies currency) => $"1{CurrencyHelper.GetCurrencySymbol(currency)} = {await CurrencyHelper.GetValueInRoublesAsync(currency):N0}" +
            $"{CurrencyHelper.GetCurrencySymbol(Currencies.Rouble)}";
